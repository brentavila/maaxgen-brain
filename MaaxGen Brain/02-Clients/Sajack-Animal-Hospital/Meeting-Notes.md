# Sajack Animal Hospital Meeting Notes
...
4. In Cursor, ask: *"Process the Sajack meeting notes from Data/Meetings/[filename] into Meeting-Notes.md and update Next-Actions."*
...
When loading Sajack context, read this file after [[Change-Log]] and [[Test-Results]] to capture client voice, priorities, and commitments from live conversations. Route outcomes as follows:
